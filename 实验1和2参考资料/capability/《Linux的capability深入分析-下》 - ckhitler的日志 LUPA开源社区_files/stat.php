...
var cnzz_data='&r='+escape(cnzz_ref.substr(0,512))+'&lg='+escape(navigator.systemLanguage)+'&ntime=0.40580300 1323223666';
...
if(cnzz_eid==-1) cnzz_eid=Math.floor(Math.random()*100000000)+"-"+1323223666+"-"+cnzz_ref.substr(0,64);
